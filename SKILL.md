...
metadata: {"openclaw":{"requires":{"bins":["git","date","python3"],"env":{"CLAWD_DIR":"optional — workspace path, defaults to cwd. Set explicitly for reliable operation."},"note":"Set CLAWD_DIR to your workspace before running. Auto-apply and aggressive cleanup are disabled by default. python3 required for trend detection."}}}
---
